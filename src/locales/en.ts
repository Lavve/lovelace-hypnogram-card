export default {
  ...
  'card.duration.hours_minutes': '{hours}h {minutes}m',
  'card.duration.hours_only': '{hours}h',
  'card.duration.minutes_only': '{minutes}m',
  'card.sleep_efficiency': '{value}% efficiency',
  'card.sleep_cycles': '{count} cycles',
  // Editor
  'editor.title_label': 'Title',
  'editor.show_title_label': 'Show title',
  'editor.show_legends_label': 'Show legends',
  'editor.legend_format_label': 'Legend value format',
  'editor.legend_format_helper':
    'Show phase duration, percentage, or both beside each legend label.',
  'editor.legend_format.none': 'Phase name only',
  'editor.legend_format.percent': 'Percent (50%)',
  'editor.legend_format.duration': 'Duration (4h 38m)',
  'editor.legend_format.both': 'Both (4h 38m (50%))',
  'editor.show_sleep_efficiency_label': 'Show sleep efficiency',
  'editor.show_sleep_efficiency_helper':
    'Actual sleep time divided by total time in bed, shown as a percentage in the header.',
  'editor.show_sleep_cycles_label': 'Show estimated sleep cycles',
  'editor.show_sleep_cycles_helper':
    'Counts dips into deep sleep during the night and shows the total in the header.',
